...
- The next high-value borrow area is now the remaining overlay-adjacent and utility families beyond code-snippet, plus any spacing invariants that still need to be promoted into stronger repo-level validation.
