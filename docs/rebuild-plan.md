...
- `bf-grid` remains the canonical page/layout grid. Dense inspector parameter matrices now use the canonical `bf-control-grid` plus stacked `p-slider__wrapper` pairs instead of carrying a second legacy grid surface.
