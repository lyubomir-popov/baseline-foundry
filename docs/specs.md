...
| Spec | Package | Status |
|---|---|---|
| 004 Application navigation geometry | [`004-application-navigation-geometry/`](../specs/004-application-navigation-geometry/) | Released on `main` at `f249a8a`; downstream Registry refresh verified and pushed. |
