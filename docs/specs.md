...
| Spec | Package | Status |
|---|---|---|
| 002 Element-owned typography selectors | [`002-element-owned-typography/`](../specs/002-element-owned-typography/) | Accepted for merge on `feat/002-element-owned-typography`; release review and full gates are green. |
