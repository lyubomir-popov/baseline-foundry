...
| 014 Framework health hardening | [`014-framework-health-hardening/`](spec-archive/014-framework-health-hardening/) | Accepted and merged through PR #1 at `181d64d` on 2026-08-28; both supported Node release gates passed. Version 0.1.4 is pending publication from the archive/status commit. |
