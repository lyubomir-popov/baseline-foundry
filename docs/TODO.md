...
- Highest-priority non-downstream cleanup is now the parasite class sweep: remove any remaining downstream-only component aliases that survived the earlier living-spec audit passes.
