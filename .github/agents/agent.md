...
All workspace instructions, documentation conventions, and architecture rules live in `.github/copilot-instructions.md`. This agent inherits those automatically.
