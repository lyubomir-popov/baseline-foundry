...
const TOGGLE_SELECTOR = ".vr-contextual-menu__toggle, .p-contextual-menu__toggle, .bf-contextual-menu__toggle";
const DROPDOWN_SELECTOR = ".vr-contextual-menu__dropdown, .p-contextual-menu__dropdown, .bf-contextual-menu__dropdown";
const MENU_SELECTOR = ".vr-contextual-menu, .p-contextual-menu, .bf-contextual-menu, .vr-contextual-menu--left, .p-contextual-menu--left, .bf-contextual-menu--left, .vr-contextual-menu--center, .p-contextual-menu--center, .bf-contextual-menu--center";
const LINK_SELECTOR = ".vr-contextual-menu__link, .p-contextual-menu__link, .bf-contextual-menu__link";
