...
export function validateSpacingSpecPage(spacingSpecHtml: string, horizontalAuditHtml: string, verticalAuditHtml: string, specShellCss: string): void {
  ...
  assert(iconNavigationBucket.includes("Tree child") && iconNavigationBucket.includes("Side navigation, plain") && iconNavigationBucket.includes("Side navigation, disclosure"), "Expected the brand tag, tree child, plain navigation, and disclosure navigation to remain directly comparable on the shared continuation rail.");
