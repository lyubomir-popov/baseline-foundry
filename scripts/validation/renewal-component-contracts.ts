...
export function validateRenewalComponentContracts(
  ...
  assert(css.includes("--bf-side-navigation-content-inset: var(--bf-component-inline-inset-action);") && css.includes("--bf-side-navigation-disclosure-inset: max(0rem, calc(var(--bf-component-inline-inset-continuation) - var(--bf-disclosure-icon-inline-size) - var(--bf-disclosure-gap)));"), "Expected side-navigation rows to choose the action or continuation inset without introducing another component rail.");
