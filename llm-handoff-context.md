...
- [ ] Continue the remaining parity pass after `list-tree` and `contextual-menu`, especially `tooltip`, `code-snippet`, and any overlay-adjacent pieces that prove necessary during downstream swap testing
