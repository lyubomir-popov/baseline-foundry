...
- [ ] Evaluate whether the `pragma` cap-unit approach actually simplifies baseline-aligned text for app-tier container-owned layouts, then record whether it should replace, complement, or stay secondary to the metrics-derived engine
