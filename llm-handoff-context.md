...
- [ ] Rework chips, badges, and status labels around explicit compact UI type contracts and Vanilla-style padding/min-width derivation instead of reusing body/h5 roles plus generic baseline fractions
