...
- [ ] Continue the remaining parity pass after `list-tree`, `contextual-menu`, `tooltip`, and `code-snippet`, especially any overlay-adjacent pieces that prove necessary during downstream swap testing
