...
- [x] Land the tier-and-engine refactor in stages: cap engine is now the default; routing variables are per-element; `.bf-engine-metrics` is the opt-in override
