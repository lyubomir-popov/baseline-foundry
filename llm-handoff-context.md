...
- [ ] Port the strongest remaining downstream-specific no-analog patterns called out in `docs/brand-layout-ops-styles-replacement-report.md`, especially equal-width dense tabs, preset radio rows, and style palette cards
...
- [ ] Decide whether color-input sizing, tight help-text spacing, and the operator-selector micro-pattern deserve upstream components or should remain app-local after the first swap pass
